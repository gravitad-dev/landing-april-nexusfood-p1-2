      ...
      <header>
        <nav className='flex justify-between px-6 xl:px-12 py-2 sm:p-3 items-center w-full'>
          ...
          <div className='items-center text-[12px] break2:text-[1rem] hidden sm:flex -space-x-4 sm:pl-8 xl:space-x-6 min-w-max-content px-4'>
            ...
            <a
              href='https://nexusfood.blog.smartbiderdev.com/contacto'
              target='_blank'
            >
              <button className='sm:bg-transparent text-gray_default hover:text-primary active:text-primary py-2 px-6 md:py-3 md:px-9 cursor-pointer whitespace-nowrap button-class'>
